      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-amber-500 to-amber-600 px-8 py-10 text-white text-center">
            ...
            <h1 className="text-3xl font-bold mb-2">Welcome, Cashier! 👋</h1>
            <p className="text-amber-50 text-lg">
              {profile && profile.cashierName 
          ...
          <form onSubmit={handleSave} className="p-8 space-y-6">
            ...
            <div className="flex flex-col items-center">
              <div className="relative group">
                <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-amber-200 dark:border-amber-900 bg-gray-100 dark:bg-slate-700 flex items-center justify-center">
                  {profilePic ? (
              ...
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-400">Click camera icon to upload photo</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-900 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={user.email}
                  disabled
                  className="block w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-slate-600 rounded-xl bg-gray-50 dark:bg-slate-800 text-gray-500 dark:text-gray-400 cursor-not-allowed"
                />
              </div>
            </div>
